...
@section ('body_title') List User @endsection
...
<div class="row">
	...
	<div class="col-12">
		<div class="card">
			<div class="card-body">
				<div class="card-title text-center">List User</div>
						...
						<tbody>
							...
							<tr>
								...
								<td style="width: 140px;" class="text-left">
									<a href="{{ route('user.edit', ['id'=>$value->id]) }}" class="btn btn-warning"><i class="fa fa-edit"></i>Edit</a>
									<a href="{{ route('user.delete', ['id'=>$value->id]) }}" onclick="return confirm('are you sure?')" class="btn btn-danger"><i class="fa fa-trash"></i></a>
								</td>
							</tr>
							@endforeach
						</tbody>
