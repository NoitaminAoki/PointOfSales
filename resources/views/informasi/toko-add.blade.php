...
@section ('body_title') Buat Informasi Toko @endsection
	...
	<div class="col-12">
		<div class="card">
			<div class="card-body">
				...
				<form onsubmit="return confirm('Are you sure?')" action="{{ route('informasi.save') }}" method="post" enctype="multipart/form-data">
					@csrf
					<div class="row">
						<div class="col-md-6">
							<div class="col-12 mb-2">
								<h5 class="font-weight-bold">Nama Instansi</h5>
								<input type="text" name="NamaKoperasi" class="form-control" required autocomplete="off">
							</div>
							<div class="col-12 mb-2">
