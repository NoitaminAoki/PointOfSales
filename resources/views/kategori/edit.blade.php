...
@section ('body_title') Edit Category @endsection
		...
		<div class="card">
			<div class="card-body">
				<div class="col-12 my-2 text-center">
					<h3 class="font-weight-bold text-uppercase">Edit Selected Category</h3>
				</div>
				<form onsubmit="return confirm('Are you sure?')" method="post" action="{{route('kategori.update')}}">
					<div class="col-md-8 mx-auto">
						{!! csrf_field() !!}
						<div class="col-12 mt-2">
							<label>Category<small class="text-danger">*</small></label>
							<input type="hidden" class="form-control" name="_id" value="{{ $kategori->_id }}" required>
							<input type="text" class="form-control" name="Kategori" value="{{ $kategori->Kategori }}" required autocomplete="off">
						</div>
