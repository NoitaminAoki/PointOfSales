...
@section ('body_title') List Category @endsection
...
<div class="row">
	...
	<div class="col-12">
		<div class="card">
			<div class="card-body">
				<div class="col-12">
					<a href="{{ route('kategori.add') }}" class="btn btn-primary">Add New Category</a>
				</div>
				<div class="card-title text-center">List Category</div>
						...
						<tbody>
							...
							<tr>
								...
								<td style="width: 130px;" class="text-left">
									<a href="{{ route('kategori.edit', ['id'=>$value->id]) }}" class="btn btn-warning"><i class="fa fa-edit"></i>Edit</a>
									<a href="{{ route('kategori.delete', ['id'=>$value->id]) }}" onclick="return confirm('are you sure?')" class="btn btn-danger"><i class="fa fa-trash"></i></a>
								</td>
							</tr>
							@endforeach
						</tbody>
